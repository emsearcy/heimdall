...
## [0.16.0](https://github.com/emsearcy/heimdall/compare/v0.15.0...v0.16.0) (2025-04-03)


### ⚠ BREAKING CHANGES

* Configuration settings for services exposed by heimdall simplified ([#2089](https://github.com/emsearcy/heimdall/issues/2089))
* Made the usage of `if` clauses in authentication & authorization, and error pipelines consistent ([#1784](https://github.com/emsearcy/heimdall/issues/1784))
* Deprecated OTEL attributes replaced ([#1669](https://github.com/emsearcy/heimdall/issues/1669))
* Configuration of `signer` moved into `jwt` finalizer ([#1534](https://github.com/emsearcy/heimdall/issues/1534))
* Demo installation removed from the helm chart ([#1544](https://github.com/emsearcy/heimdall/issues/1544))
* Subject has been made immutable ([#1487](https://github.com/emsearcy/heimdall/issues/1487))
* Rule matching configuration API redesigned ([#1358](https://github.com/emsearcy/heimdall/issues/1358))
* Default rule rejects requests with encoded slashes in the path of the URL with `400 Bad Request` ([#1358](https://github.com/emsearcy/heimdall/issues/1358))
* Support for `rule_path_match_prefix` on endpoint configurations for `http_endpoint` and `cloud_blob` providers has been dropped ([#1358](https://github.com/emsearcy/heimdall/issues/1358))
* Endpoint specific HTTP cache settings refactored to allow HTTP cache ttl definition ([#1043](https://github.com/emsearcy/heimdall/issues/1043))
* Support for `X-Forwarded-Path` header dropped ([#1073](https://github.com/emsearcy/heimdall/issues/1073))
* `if` conditional statements for error pipeline mechanisms ([#1055](https://github.com/emsearcy/heimdall/issues/1055))
* `Request.ClientIP` renamed to `Request.ClientIPAddresses` to reflect the actual contents ([#1066](https://github.com/emsearcy/heimdall/issues/1066))
* The term "scheme" is used properly as defined by RFC9110 ([#1042](https://github.com/emsearcy/heimdall/issues/1042))
* Rule(-Set) related configuration properties `mechanisms` , `default` and `providers` moved one level up and renamed ([#1028](https://github.com/emsearcy/heimdall/issues/1028))
* Support for `noop` authenticator removed ([#1015](https://github.com/emsearcy/heimdall/issues/1015))
* Endpoint specific `client_credentials` auth strategy renamed to `oauth2_client_credentials` ([#975](https://github.com/emsearcy/heimdall/issues/975))
* `unifier` renamed to `finalizer` ([#956](https://github.com/emsearcy/heimdall/issues/956))
* Support for OTEL metrics ([#948](https://github.com/emsearcy/heimdall/issues/948))
* Proxy implementation migrated from fiber to stdlib http package ([#889](https://github.com/emsearcy/heimdall/issues/889))
* Support for OpenTelemetry Jaeger exporter dropped (It has been deprecated by Jaeger back in 2022) ([#884](https://github.com/emsearcy/heimdall/issues/884))

### Features

* `client_credentials` authentication strategy for `Endpoint` enhanced to support the same options as the corresponding finalizer ([#971](https://github.com/emsearcy/heimdall/issues/971)) ([ec16d5d](https://github.com/emsearcy/heimdall/commit/ec16d5de59196ca95c7e8dd34a5ccbc8e97b4b9b))
* `env` settings in helm chart extended to support ConfigMaps, Secrets and Pod configuration in addition to string literals ([#1128](https://github.com/emsearcy/heimdall/issues/1128)) by [@martin31821](https://github.com/martin31821) ([bf75c97](https://github.com/emsearcy/heimdall/commit/bf75c97de9346169acbc2a9496fb7756814a5e60))
* `finalizers` are optional ([#1027](https://github.com/emsearcy/heimdall/issues/1027)) ([864c879](https://github.com/emsearcy/heimdall/commit/864c879f386316b6aebd294268527c179de2ac9e))
* `if` conditional statements for error pipeline mechanisms ([#1055](https://github.com/emsearcy/heimdall/issues/1055)) ([7cf97dc](https://github.com/emsearcy/heimdall/commit/7cf97dca57e0272efa5cc851a67a8ef27279bc1b))
* `jwt` finalizer extended to support templating via `values` property ([#2193](https://github.com/emsearcy/heimdall/issues/2193)) ([bf833c4](https://github.com/emsearcy/heimdall/commit/bf833c48fa62e2f8e3388980dcd306a16da8a019))
* Access to request body in templates and CEL expressions ([#1069](https://github.com/emsearcy/heimdall/issues/1069)) ([69dd7d2](https://github.com/emsearcy/heimdall/commit/69dd7d2a35de15071be0c869bc81e8150b2e5f62))
* Configurable limits for in-memory cache ([#2333](https://github.com/emsearcy/heimdall/issues/2333)) ([c7a858a](https://github.com/emsearcy/heimdall/commit/c7a858adbbe1951a42c0f6ef3ba758f442dfbd54))
* Container images are published to GHCR in addition to DockerHub ([#1041](https://github.com/emsearcy/heimdall/issues/1041)) ([04b1066](https://github.com/emsearcy/heimdall/commit/04b106631d8db2e22b1f8d167091ab2e52eb28c2))
* Enforcement of secure configuration with Opt-Out ([#1972](https://github.com/emsearcy/heimdall/issues/1972)) ([4d89e58](https://github.com/emsearcy/heimdall/commit/4d89e580df7ebf30e8f124c2d853bdc2bd75c010))
* Glob expressions are context aware and use `.` for host related expressions and `/` for path related ones as separators ([#1358](https://github.com/emsearcy/heimdall/issues/1358)) ([f2f6867](https://github.com/emsearcy/heimdall/commit/f2f6867576b758312b1a85dc06fe52be3ae9d2ff))
* **header-finalizer:** support multiple headers with same name ([#2244](https://github.com/emsearcy/heimdall/issues/2244)) ([0413eb9](https://github.com/emsearcy/heimdall/commit/0413eb94388b6e8e166cc862d6fdde32795edc73))
* Helm chart allows usage of optionall volumes and volume mounts ([#825](https://github.com/emsearcy/heimdall/issues/825)) ([0ed2cf0](https://github.com/emsearcy/heimdall/commit/0ed2cf0c54faa904fcbbfcbba03295a8c4df0606))
* Helm Chart as OCI image ([#2327](https://github.com/emsearcy/heimdall/issues/2327)) ([ad7558b](https://github.com/emsearcy/heimdall/commit/ad7558b0c9c3f4657370eb84bd74ac2e61c9d6f2))
* Helm chart enhanced to allow passing optional arguments to heimdall ([#824](https://github.com/emsearcy/heimdall/issues/824)) ([9b0149d](https://github.com/emsearcy/heimdall/commit/9b0149dc041cb95161a4db86f8d30efe99d9b86a))
* Helm chart pulls heimdall container image from ghcr.io instead from DockerHub ([#1053](https://github.com/emsearcy/heimdall/issues/1053)) ([b3c729a](https://github.com/emsearcy/heimdall/commit/b3c729a16742890f99bdca93073ee4499a4588f6))
* Helm chart supports setting environment variables by referencing either a ConfigMap or a Secret via `envFrom` ([#1128](https://github.com/emsearcy/heimdall/issues/1128)) by [@martin31821](https://github.com/martin31821)  ([bf75c97](https://github.com/emsearcy/heimdall/commit/bf75c97de9346169acbc2a9496fb7756814a5e60))
* Hot reloading of Signer keys store ([#1232](https://github.com/emsearcy/heimdall/issues/1232)) ([36076e1](https://github.com/emsearcy/heimdall/commit/36076e1de864d969b1a23d9c4cd3e7cbfab4a38e))
* Hot reloading of TLS key stores ([#1230](https://github.com/emsearcy/heimdall/issues/1230)) ([9abf723](https://github.com/emsearcy/heimdall/commit/9abf7232725534afca0aa62b48d3aef70a3a9ea5))
* HTTP 2.0 support ([#889](https://github.com/emsearcy/heimdall/issues/889)) ([ffcccf6](https://github.com/emsearcy/heimdall/commit/ffcccf68b733c614c803f09fc50eea8e9afe1b84))
* Kubernetes RuleSet resource deployment/usage status ([#987](https://github.com/emsearcy/heimdall/issues/987)) ([738e3ec](https://github.com/emsearcy/heimdall/commit/738e3ecfe89e37fc988d5d71cc80d0e9001ac136))
* More convenient `Host` header forwarding in proxy mode ([#2265](https://github.com/emsearcy/heimdall/issues/2265)) ([c3ece0f](https://github.com/emsearcy/heimdall/commit/c3ece0fbf7d1febd08bfd2a54358624eecb12422))
* Multiple rules can be defined for the same path, e.g. to have separate rules for read and write requests ([#1358](https://github.com/emsearcy/heimdall/issues/1358)) ([f2f6867](https://github.com/emsearcy/heimdall/commit/f2f6867576b758312b1a85dc06fe52be3ae9d2ff))
* New `oauth2_client_credentials` finalizer ([#959](https://github.com/emsearcy/heimdall/issues/959)) ([4c9f807](https://github.com/emsearcy/heimdall/commit/4c9f807147b64ea301cac0a6fc44ee08610898e9))
* New `trace` log level allowing dumping HTTP requests, responses and the current Subject contents ([#877](https://github.com/emsearcy/heimdall/issues/877)) ([512f1ed](https://github.com/emsearcy/heimdall/commit/512f1ed42a792db8b43f7f6c30e9e0ffe8542c61))
* New endpoint auth type to create http message signatures for outbound requests according to RFC 9421 ([#1507](https://github.com/emsearcy/heimdall/issues/1507)) ([672988d](https://github.com/emsearcy/heimdall/commit/672988d2463ddf8abbade7cb9f0656d848682ae3))
* OAuth2/OIDC metadata discovery for `jwt` authenticator ([#1043](https://github.com/emsearcy/heimdall/issues/1043)) ([2dbfa5f](https://github.com/emsearcy/heimdall/commit/2dbfa5f49bf7611e41992d6946fe77a34cd237d3))
* OAuth2/OIDC metadata discovery for `oauth2_introspection` authenticator ([#1043](https://github.com/emsearcy/heimdall/issues/1043)) ([2dbfa5f](https://github.com/emsearcy/heimdall/commit/2dbfa5f49bf7611e41992d6946fe77a34cd237d3))
* Opt-In for url-encoded slashes in URL paths ([#1071](https://github.com/emsearcy/heimdall/issues/1071)) ([96bb188](https://github.com/emsearcy/heimdall/commit/96bb1883f09c8d7017752b50e012aa6392e658c0))
* Redis as (distributed) cache ([#999](https://github.com/emsearcy/heimdall/issues/999)) by [@tk-innoq](https://github.com/tk-innoq) ([2f9ba81](https://github.com/emsearcy/heimdall/commit/2f9ba816b37268c1348ffa6632d6a038905c8474))
* Release archive contains an SBOM in CycloneDX (json) format ([#867](https://github.com/emsearcy/heimdall/issues/867)) ([d8a7cff](https://github.com/emsearcy/heimdall/commit/d8a7cff8600a3873805aafb40c6cf60202c32320))
* Route based matching of rules ([#1766](https://github.com/emsearcy/heimdall/issues/1766)) ([8ef379d](https://github.com/emsearcy/heimdall/commit/8ef379db1d504440b6fa19794b7b38c173a730b0))
* RuleSet version increased to `1alpha3`, respectively to `v1alpha3` in k8s CRD ([#1054](https://github.com/emsearcy/heimdall/issues/1054)) ([943c9ce](https://github.com/emsearcy/heimdall/commit/943c9ce7e2777fdc8b4f806ae48ba5f8ac9fb16d))
* SBOM and attestations for published container images ([#868](https://github.com/emsearcy/heimdall/issues/868)) ([3564870](https://github.com/emsearcy/heimdall/commit/3564870d09d4bdc93e826ce2fb32860621ac69a8))
* Simpler auth stage fallbacks ([#2260](https://github.com/emsearcy/heimdall/issues/2260)) ([87bf663](https://github.com/emsearcy/heimdall/commit/87bf663b521ab2f599da238292ddbcb94f2667c1))
* SSE support ([#889](https://github.com/emsearcy/heimdall/issues/889)) ([ffcccf6](https://github.com/emsearcy/heimdall/commit/ffcccf68b733c614c803f09fc50eea8e9afe1b84))
* Support complex values in env vars during substitution ([#2349](https://github.com/emsearcy/heimdall/issues/2349)) ([a98dfc4](https://github.com/emsearcy/heimdall/commit/a98dfc4a15f3c7c51357fd9768544ca9c9320e85))
* Support for backtracking while matching rules ([#1358](https://github.com/emsearcy/heimdall/issues/1358)) ([f2f6867](https://github.com/emsearcy/heimdall/commit/f2f6867576b758312b1a85dc06fe52be3ae9d2ff))
* Support for free and single (named) wildcards for request path matching and access of the captured values from the pipeline ([#1358](https://github.com/emsearcy/heimdall/issues/1358)) ([f2f6867](https://github.com/emsearcy/heimdall/commit/f2f6867576b758312b1a85dc06fe52be3ae9d2ff))
* Support for OTEL metrics ([#948](https://github.com/emsearcy/heimdall/issues/948)) ([eeb5a82](https://github.com/emsearcy/heimdall/commit/eeb5a82dc754a24972cb295d7313b199de0a7f43))
* Support for SLSA L3 provenance ([#2321](https://github.com/emsearcy/heimdall/issues/2321)) ([1959531](https://github.com/emsearcy/heimdall/commit/1959531553ae727f6365f677eda1cbe0bd1dab47))
* Templating support in `remote` authorizer and `generic` contextualizer `values` property ([#1047](https://github.com/emsearcy/heimdall/issues/1047)) ([2835faa](https://github.com/emsearcy/heimdall/commit/2835faab03ebb2f27aa3ce826fec249375de19e4))
* Validating admission controller for RuleSet resources ([#984](https://github.com/emsearcy/heimdall/issues/984)) ([3357e57](https://github.com/emsearcy/heimdall/commit/3357e57a64abde9299339a727690db845998d4bd))
* WebSockets support ([#889](https://github.com/emsearcy/heimdall/issues/889)) ([ffcccf6](https://github.com/emsearcy/heimdall/commit/ffcccf68b733c614c803f09fc50eea8e9afe1b84))


### Code Refactorings

* `Request.ClientIP` renamed to `Request.ClientIPAddresses` to reflect the actual contents ([#1066](https://github.com/emsearcy/heimdall/issues/1066)) ([0f9484f](https://github.com/emsearcy/heimdall/commit/0f9484f9d9646c0b830a682531305fb34b84fe1b))
* `unifier` renamed to `finalizer` ([#956](https://github.com/emsearcy/heimdall/issues/956)) ([d54e39d](https://github.com/emsearcy/heimdall/commit/d54e39d3cd365b234e38ae49a193abfa4a347c99))
* Configuration of `signer` moved into `jwt` finalizer ([#1534](https://github.com/emsearcy/heimdall/issues/1534)) ([4475745](https://github.com/emsearcy/heimdall/commit/447574557d109be7f17844bc743eb9cc625427d9))
* Configuration settings for services exposed by heimdall simplified ([#2089](https://github.com/emsearcy/heimdall/issues/2089)) ([02d91d6](https://github.com/emsearcy/heimdall/commit/02d91d658727e55e4dcb62801725ab8ef57b128f))
* Default rule rejects requests with encoded slashes in the path of the URL with `400 Bad Request` ([#1358](https://github.com/emsearcy/heimdall/issues/1358)) ([f2f6867](https://github.com/emsearcy/heimdall/commit/f2f6867576b758312b1a85dc06fe52be3ae9d2ff))
* Demo installation removed from the helm chart ([#1544](https://github.com/emsearcy/heimdall/issues/1544)) ([f8770b3](https://github.com/emsearcy/heimdall/commit/f8770b3bfa3599c37290677454baa4f52c12a7a7))
* Deprecated OTEL attributes replaced ([#1669](https://github.com/emsearcy/heimdall/issues/1669)) ([e5ed3a5](https://github.com/emsearcy/heimdall/commit/e5ed3a57f5de3164200c285a811908c7a32fbfc8))
* Endpoint specific `client_credentials` auth strategy renamed to `oauth2_client_credentials` ([#975](https://github.com/emsearcy/heimdall/issues/975)) ([b11005c](https://github.com/emsearcy/heimdall/commit/b11005c5f33d70e6df1874c18e44dbddc5687b89))
* Endpoint specific HTTP cache settings refactored to allow HTTP cache ttl definition ([#1043](https://github.com/emsearcy/heimdall/issues/1043)) ([2dbfa5f](https://github.com/emsearcy/heimdall/commit/2dbfa5f49bf7611e41992d6946fe77a34cd237d3))
* Made the usage of `if` clauses in authentication & authorization, and error pipelines consistent ([#1784](https://github.com/emsearcy/heimdall/issues/1784)) ([2577f56](https://github.com/emsearcy/heimdall/commit/2577f560b80c49e3e5a4b3da547245af98844843))
* Proxy implementation migrated from fiber to stdlib http package ([#889](https://github.com/emsearcy/heimdall/issues/889)) ([ffcccf6](https://github.com/emsearcy/heimdall/commit/ffcccf68b733c614c803f09fc50eea8e9afe1b84))
* Rule matching configuration API redesigned ([#1358](https://github.com/emsearcy/heimdall/issues/1358)) ([f2f6867](https://github.com/emsearcy/heimdall/commit/f2f6867576b758312b1a85dc06fe52be3ae9d2ff))
* Rule(-Set) related configuration properties `mechanisms` , `default` and `providers` moved one level up and renamed ([#1028](https://github.com/emsearcy/heimdall/issues/1028)) ([f6ce3b8](https://github.com/emsearcy/heimdall/commit/f6ce3b88a7d7193dcb2365a3ce0772f9504ee4eb))
* Subject has been made immutable ([#1487](https://github.com/emsearcy/heimdall/issues/1487)) ([6c4957f](https://github.com/emsearcy/heimdall/commit/6c4957fd897de55de4b23563be4406423ba26b00))
* Support for `noop` authenticator removed ([#1015](https://github.com/emsearcy/heimdall/issues/1015)) ([8cb3bd3](https://github.com/emsearcy/heimdall/commit/8cb3bd3777afa0f53c602782e1fa282309ea7fee))
* Support for `rule_path_match_prefix` on endpoint configurations for `http_endpoint` and `cloud_blob` providers has been dropped ([#1358](https://github.com/emsearcy/heimdall/issues/1358)) ([f2f6867](https://github.com/emsearcy/heimdall/commit/f2f6867576b758312b1a85dc06fe52be3ae9d2ff))
* Support for `X-Forwarded-Path` header dropped ([#1073](https://github.com/emsearcy/heimdall/issues/1073)) ([342c11a](https://github.com/emsearcy/heimdall/commit/342c11a4123700928b5a3793685e0b08bb56a659))
* Support for OpenTelemetry Jaeger exporter dropped (It has been deprecated by Jaeger back in 2022) ([#884](https://github.com/emsearcy/heimdall/issues/884)) ([97b81b1](https://github.com/emsearcy/heimdall/commit/97b81b199c1d0250ca94a99d61e701b1f482328c))


### Performance Improvements

* O(log(n)) time complexity for lookup of rules ([#1358](https://github.com/emsearcy/heimdall/issues/1358)) ([f2f6867](https://github.com/emsearcy/heimdall/commit/f2f6867576b758312b1a85dc06fe52be3ae9d2ff))


### Bug Fixes

* `audience` assertion adheres to RFC-7519, section 4.1.3 ([#1237](https://github.com/emsearcy/heimdall/issues/1237)) ([560a470](https://github.com/emsearcy/heimdall/commit/560a470c5ce89e964065918b9369780ab0a6ba36))
* Accept header usage ([#1107](https://github.com/emsearcy/heimdall/issues/1107)) ([f738ee8](https://github.com/emsearcy/heimdall/commit/f738ee80220e35e4c361437d86ccdab9f5a894c5))
* Corrected the placement of namespace selector properties in the Helm chart's admission controller configuration ([#1752](https://github.com/emsearcy/heimdall/issues/1752)). ([4c059b3](https://github.com/emsearcy/heimdall/commit/4c059b38510a1aa2d37d9103a3cb8935f4c2043b))
* Fixed a nil pointer error in the Helm chart that occurred when a deployment was configured with custom annotations due to an incorrect reference in the deployment template ([#1752](https://github.com/emsearcy/heimdall/issues/1752)). ([4c059b3](https://github.com/emsearcy/heimdall/commit/4c059b38510a1aa2d37d9103a3cb8935f4c2043b))
* HTTP method expansion in k8s RuleSet resources ([#1005](https://github.com/emsearcy/heimdall/issues/1005)) ([861c2b6](https://github.com/emsearcy/heimdall/commit/861c2b6273ff0971013d1120ed463d0f5d230e1b))
* Kubernetes RuleSet resource is unloaded by heimdall on authClassName mismatch ([#987](https://github.com/emsearcy/heimdall/issues/987)) ([738e3ec](https://github.com/emsearcy/heimdall/commit/738e3ecfe89e37fc988d5d71cc80d0e9001ac136))
* Making use of better constraints in the definition of the RuleSet CRD to not exceed the k8s rule cost budget ([#1004](https://github.com/emsearcy/heimdall/issues/1004)) ([7d71351](https://github.com/emsearcy/heimdall/commit/7d71351188d88774f609f0996c8de689833392e3))
* MIME type decoder covers optional parameters ([#1057](https://github.com/emsearcy/heimdall/issues/1057)) ([c1c088c](https://github.com/emsearcy/heimdall/commit/c1c088c105942af0f614e7869b15a17bedb5e31f))
* Quoting configured env vars in helm chart ([#827](https://github.com/emsearcy/heimdall/issues/827)) ([b4eeb96](https://github.com/emsearcy/heimdall/commit/b4eeb962c55aa06cdebae0febc4aba248cf74995))
* Rule set, the rule is loaded from, is considered while updating or deleting rules ([#1298](https://github.com/emsearcy/heimdall/issues/1298)) ([e571248](https://github.com/emsearcy/heimdall/commit/e5712485d52b0c169964a634ab1ac33631075c84))
* Setting of binary artifacts version fixed ([#1087](https://github.com/emsearcy/heimdall/issues/1087)) ([f7dbbee](https://github.com/emsearcy/heimdall/commit/f7dbbee5ecc42b9182ef164c6c76ad09807d666f))
* Taking updates of certificates into account while collecting metrics ([#1534](https://github.com/emsearcy/heimdall/issues/1534)) ([4475745](https://github.com/emsearcy/heimdall/commit/447574557d109be7f17844bc743eb9cc625427d9))
* The term "scheme" is used properly as defined by RFC9110 ([#1042](https://github.com/emsearcy/heimdall/issues/1042)) ([aaf4bd3](https://github.com/emsearcy/heimdall/commit/aaf4bd351dbf8feaccdd5705e748931a6b759d84))
* Updated the admission controller configuration in the Helm chart to align with the redesigned structure done in v0.12.0-alpha release of heimdall ([#1752](https://github.com/emsearcy/heimdall/issues/1752)). ([4c059b3](https://github.com/emsearcy/heimdall/commit/4c059b38510a1aa2d37d9103a3cb8935f4c2043b))
* Usage of `X-Forwarded-*` headers enhanced security wise ([#839](https://github.com/emsearcy/heimdall/issues/839)) ([cd4f7e8](https://github.com/emsearcy/heimdall/commit/cd4f7e8b603992831a1bd617f6853751574fd016))
* Validation of a self-signed certificate does not require its presence in the system wide trust store any more ([#830](https://github.com/emsearcy/heimdall/issues/830)) ([56a2d1f](https://github.com/emsearcy/heimdall/commit/56a2d1f33fd0c207dbda0eb033ec02a66684818a))


### Documentation

* Caddy integration guide and demo examples ([#2191](https://github.com/emsearcy/heimdall/issues/2191)) ([3ba8c7b](https://github.com/emsearcy/heimdall/commit/3ba8c7b117b6730debc4f46a2346ebe36ac505a5))
* Contour integration guide updated to cover global configuration in addition to the route based one ([#1253](https://github.com/emsearcy/heimdall/issues/1253)) ([74bcebd](https://github.com/emsearcy/heimdall/commit/74bcebd2cafb93c609c17b16c626cfa2148ad8ea))
* Documentation restructured to make it more comprehensive ([#1075](https://github.com/emsearcy/heimdall/issues/1075)) by [@godrin](https://github.com/godrin), @REABMAX, @Ebano and @KieronWiltshire ([6612633](https://github.com/emsearcy/heimdall/commit/66126336e34a388bceb82d9c79bde84bc0735918))
* Extend installation section to include Heimdall installation via Nix package manager ([#2257](https://github.com/emsearcy/heimdall/issues/2257)) ([6e9cbc6](https://github.com/emsearcy/heimdall/commit/6e9cbc63e7a9821caf067b9c034d249ecd88c985))
* Guide for First-Party Authentication with OpenID Connect ([#1789](https://github.com/emsearcy/heimdall/issues/1789)) ([8c6b9c3](https://github.com/emsearcy/heimdall/commit/8c6b9c3c4fec7cc605fc8a1058e0847e7abb3947))
* HAProxy guide updated to cover global integration with the Ingress Controller ([#1240](https://github.com/emsearcy/heimdall/issues/1240)) ([ed27797](https://github.com/emsearcy/heimdall/commit/ed27797fc2be0c804c7da28dad3c0b6203193b13))
* Integration guide and demo for (Ambassador) emissary ingress controller ([#838](https://github.com/emsearcy/heimdall/issues/838)) ([456cfd5](https://github.com/emsearcy/heimdall/commit/456cfd5c4dad6a4c972679882ae9071299608d65))
* Integration guide and demo for HAProxy ingress controller ([#837](https://github.com/emsearcy/heimdall/issues/837)) ([3766fa2](https://github.com/emsearcy/heimdall/commit/3766fa2093aa5c612a547bdd7d71097f638256ff))
* Integration guide and examples for Istio service mesh ([#1832](https://github.com/emsearcy/heimdall/issues/1832)) ([35c2fe2](https://github.com/emsearcy/heimdall/commit/35c2fe2bde64f2b3a52d76ea6f45c51e1f1fe373))
* Integration guide for OpenFGA ([#1299](https://github.com/emsearcy/heimdall/issues/1299)) ([1d8bea2](https://github.com/emsearcy/heimdall/commit/1d8bea2b2945f895467e0e28e4f16df5c5942f47))
* New integration guide for Contour ingress controller ([#828](https://github.com/emsearcy/heimdall/issues/828)) ([ea62e91](https://github.com/emsearcy/heimdall/commit/ea62e9195f3516b6a70a67bd4b475ec3f7bf99e7))
* New integration guide for Envoy Gateway ([#1412](https://github.com/emsearcy/heimdall/issues/1412)) ([526f381](https://github.com/emsearcy/heimdall/commit/526f381c931cd58e9513716a1bc7fa9149c36e3d))
* New landing page ([#853](https://github.com/emsearcy/heimdall/issues/853)) ([fc2a337](https://github.com/emsearcy/heimdall/commit/fc2a337b77dbed96a837122cbdb6480323b32c1d))
* New sections describing signature verification of released archives, container images and the SBOM. ([#872](https://github.com/emsearcy/heimdall/issues/872)) ([8f42c24](https://github.com/emsearcy/heimdall/commit/8f42c240026cb5e32d305168b2d265c9c2b50d6b))
* NGING Ingress Controller guide updated to cover global integration options ([#1469](https://github.com/emsearcy/heimdall/issues/1469)) ([a710a64](https://github.com/emsearcy/heimdall/commit/a710a640fc1ce2cadfa37eb59a4fc0fa52c5120b))
* Traefik guide updated to cover `Ingress`, `IngressRoute` and `HTTPRoute` based integration options ([#1420](https://github.com/emsearcy/heimdall/issues/1420)) ([303095e](https://github.com/emsearcy/heimdall/commit/303095e204c3ea753b06a2b90171462de19b1eb4))
* Traefik integration guide updated to cover global configuration in addition to the route based one ([#1269](https://github.com/emsearcy/heimdall/issues/1269)) ([73b1d4c](https://github.com/emsearcy/heimdall/commit/73b1d4cc0a9242597a700054271ef5d0c006855b))


### Dependencies

* update dependency @mermaid-js/mermaid-cli to v10.3.0 ([#820](https://github.com/emsearcy/heimdall/issues/820)) ([70e8217](https://github.com/emsearcy/heimdall/commit/70e82172eb40617f1cde83fdf304a00a0e7ee09f))
* update golang to 1.21.4 ([79a0106](https://github.com/emsearcy/heimdall/commit/79a01060864fea27ab5709eaa096461cc26b5fc0))
* update golang to 1.21.5 ([#1082](https://github.com/emsearcy/heimdall/issues/1082)) ([a996ce7](https://github.com/emsearcy/heimdall/commit/a996ce78d7f28a390190a7c7a04262dc370782f2))
* update golang to 1.22.1 ([#1219](https://github.com/emsearcy/heimdall/issues/1219)) ([4449cb7](https://github.com/emsearcy/heimdall/commit/4449cb7384c4b76aec596d06ec64477ebc1b5fa3))
* update golang to v1.23.1 ([#1793](https://github.com/emsearcy/heimdall/issues/1793))  ([54e6cad](https://github.com/emsearcy/heimdall/commit/54e6cad5e4e8b909f646e2f0318f94388f793039))
* update golang.org/x/exp digest to 02704c9 ([#1111](https://github.com/emsearcy/heimdall/issues/1111)) ([1e18000](https://github.com/emsearcy/heimdall/commit/1e18000557ebf023a596b5379ef10413d2192f16))
* update golang.org/x/exp digest to 050eac2 ([#842](https://github.com/emsearcy/heimdall/issues/842)) ([964a867](https://github.com/emsearcy/heimdall/commit/964a867aa689f57dbb6e92b78d7d05e1fb1a1acf))
* update golang.org/x/exp digest to 6522937 ([#1068](https://github.com/emsearcy/heimdall/issues/1068)) ([83827ae](https://github.com/emsearcy/heimdall/commit/83827ae38c9f8274555cb652b0f6a35b06230ae2))
* update golang.org/x/exp digest to 701f63a ([#1793](https://github.com/emsearcy/heimdall/issues/1793)) ([54e6cad](https://github.com/emsearcy/heimdall/commit/54e6cad5e4e8b909f646e2f0318f94388f793039))
* update golang.org/x/exp digest to a685a6e ([#1245](https://github.com/emsearcy/heimdall/issues/1245)) ([41ba4a2](https://github.com/emsearcy/heimdall/commit/41ba4a2a9b2737e11f4f455cb68fa353a0bbff9a))
* update golang.org/x/exp digest to d63ba01 ([#815](https://github.com/emsearcy/heimdall/issues/815)) ([ca7a6e2](https://github.com/emsearcy/heimdall/commit/ca7a6e28935f1017ec565a975e4a0ab58375c735))
* update google.golang.org/genproto/googleapis/rpc digest to 1744710 ([#841](https://github.com/emsearcy/heimdall/issues/841)) ([8f5c5e3](https://github.com/emsearcy/heimdall/commit/8f5c5e3f5e9276a57ead596e370c65b5668dbb16))
* update google.golang.org/genproto/googleapis/rpc digest to 3a041ad ([#1067](https://github.com/emsearcy/heimdall/issues/1067)) ([431fd89](https://github.com/emsearcy/heimdall/commit/431fd89fb9312331fd3577c75a4ff1653e717e7b))
* update google.golang.org/genproto/googleapis/rpc digest to 50ed04b ([#1115](https://github.com/emsearcy/heimdall/issues/1115)) ([eda1d2d](https://github.com/emsearcy/heimdall/commit/eda1d2d48b8163fbcb442ed191f425c2cb4ad7b5))
* update google.golang.org/genproto/googleapis/rpc digest to 8af14fe ([#1793](https://github.com/emsearcy/heimdall/issues/1793)) ([54e6cad](https://github.com/emsearcy/heimdall/commit/54e6cad5e4e8b909f646e2f0318f94388f793039))
* update google.golang.org/genproto/googleapis/rpc digest to c3f9821 ([#1301](https://github.com/emsearcy/heimdall/issues/1301)) ([4ccf593](https://github.com/emsearcy/heimdall/commit/4ccf5932cc49176dd7de520dc9da583ddaab6b29))
* update google.golang.org/genproto/googleapis/rpc digest to f966b18 ([#818](https://github.com/emsearcy/heimdall/issues/818)) ([2797dc2](https://github.com/emsearcy/heimdall/commit/2797dc2854b16e6f023041e7fb623ee355e056df))
* update kubernetes packages to v0.28.4 ([#1040](https://github.com/emsearcy/heimdall/issues/1040)) ([312ace1](https://github.com/emsearcy/heimdall/commit/312ace19ad97a4c54c6e066290faf1823d876b09))
* update kubernetes packages to v0.29.0 ([#1100](https://github.com/emsearcy/heimdall/issues/1100)) ([65b3619](https://github.com/emsearcy/heimdall/commit/65b361936ca417972b91bd432a87a09008673810))
* update kubernetes packages to v0.29.3 ([#1249](https://github.com/emsearcy/heimdall/issues/1249)) ([43f3233](https://github.com/emsearcy/heimdall/commit/43f32335752c8d85cba61eb2a74827274e2a6d84))
* update module github.com/dlclark/regexp2 to v1.11.0 ([#1209](https://github.com/emsearcy/heimdall/issues/1209)) ([c51eda9](https://github.com/emsearcy/heimdall/commit/c51eda927d4587560cd1cf17f1547488c01d15dd))
* update module github.com/envoyproxy/go-control-plane to v0.12.0 ([#1117](https://github.com/emsearcy/heimdall/issues/1117)) ([7fbb737](https://github.com/emsearcy/heimdall/commit/7fbb737308bb6272423f66b6793aaa5c3a046e32))
* update module github.com/evanphx/json-patch/v5 to v5.9.0 ([#1156](https://github.com/emsearcy/heimdall/issues/1156)) ([3770509](https://github.com/emsearcy/heimdall/commit/377050997851d2360948484def70916c1771ff60))
* update module github.com/felixge/httpsnoop to v1.0.4 ([#995](https://github.com/emsearcy/heimdall/issues/995)) ([10006e5](https://github.com/emsearcy/heimdall/commit/10006e54c6dde8809b5a25216a0eb236987ef41b))
* update module github.com/fsnotify/fsnotify to v1.7.0 ([#981](https://github.com/emsearcy/heimdall/issues/981)) ([4c7bd90](https://github.com/emsearcy/heimdall/commit/4c7bd90e134bd36e04f2bb82cca87a82d3803502))
* update module github.com/go-co-op/gocron to v1.30.2 ([#817](https://github.com/emsearcy/heimdall/issues/817)) ([cab5b33](https://github.com/emsearcy/heimdall/commit/cab5b3302eb7b1faa942dc74bc4ed832c95c9a5e))
* update module github.com/go-co-op/gocron to v1.31.0 ([#819](https://github.com/emsearcy/heimdall/issues/819)) ([303ee11](https://github.com/emsearcy/heimdall/commit/303ee117eb29992cd2c4c72c078cf585b2831c74))
* update module github.com/go-co-op/gocron to v1.36.0 ([#1013](https://github.com/emsearcy/heimdall/issues/1013)) ([dd44dc2](https://github.com/emsearcy/heimdall/commit/dd44dc2bb7446b32cd2bca87c59be31529503a03))
* update module github.com/go-co-op/gocron/v2 to v2.1.2 ([#1116](https://github.com/emsearcy/heimdall/issues/1116)) ([13505da](https://github.com/emsearcy/heimdall/commit/13505daf736278beadf36fc6c67534a894ed2b75))
* update module github.com/go-co-op/gocron/v2 to v2.2.9 ([#1292](https://github.com/emsearcy/heimdall/issues/1292)) ([3555329](https://github.com/emsearcy/heimdall/commit/35553294290871fe13ae078b46894114be615a2a))
* update module github.com/go-jose/go-jose/v4 to v4.0.1 [security] ([#1225](https://github.com/emsearcy/heimdall/issues/1225)) ([45e5a46](https://github.com/emsearcy/heimdall/commit/45e5a46aea979cc5dfe6d85369e600c01b032e7d))
* update module github.com/go-playground/validator/v10 to v10.19.0 ([#1217](https://github.com/emsearcy/heimdall/issues/1217)) ([564d256](https://github.com/emsearcy/heimdall/commit/564d256a44f25e464dcfbee35d93b512b92fcbe3))
* update module github.com/go-playground/validator/v10 to v10.22.1 ([#1793](https://github.com/emsearcy/heimdall/issues/1793)) ([54e6cad](https://github.com/emsearcy/heimdall/commit/54e6cad5e4e8b909f646e2f0318f94388f793039))
* update module github.com/google/cel-go to v0.18.2 ([#1016](https://github.com/emsearcy/heimdall/issues/1016)) ([d4e6d6f](https://github.com/emsearcy/heimdall/commit/d4e6d6f64bb9d1ef013cc001bb1cbd9fd800d36d))
* update module github.com/google/cel-go to v0.20.1 ([#1224](https://github.com/emsearcy/heimdall/issues/1224)) ([a0669a8](https://github.com/emsearcy/heimdall/commit/a0669a818b0454f9e5f675502e41402acf991daf))
* update module github.com/google/uuid to v1.4.0 ([#985](https://github.com/emsearcy/heimdall/issues/985)) ([0d9666d](https://github.com/emsearcy/heimdall/commit/0d9666d0812aef7173e2d0f6681c40fd42a98435))
* update module github.com/google/uuid to v1.5.0 ([#1097](https://github.com/emsearcy/heimdall/issues/1097)) ([5273ac8](https://github.com/emsearcy/heimdall/commit/5273ac8008263393027b29a04534d96028445bb7))
* update module github.com/google/uuid to v1.6.0 ([#1151](https://github.com/emsearcy/heimdall/issues/1151)) ([5f9dc9c](https://github.com/emsearcy/heimdall/commit/5f9dc9c819a7a3454dc2b1f13ffb1c6c41648114))
* update module github.com/grpc-ecosystem/go-grpc-middleware/v2 to v2.0.1 ([#930](https://github.com/emsearcy/heimdall/issues/930)) ([06697fe](https://github.com/emsearcy/heimdall/commit/06697fedabe069b1c4d515e37061865c467b85fc))
* update module github.com/grpc-ecosystem/go-grpc-middleware/v2 to v2.1.0 ([#1241](https://github.com/emsearcy/heimdall/issues/1241)) ([bff3874](https://github.com/emsearcy/heimdall/commit/bff38740dd16d63b11a1ff4f2df4db647a43511a))
* update module github.com/jellydator/ttlcache/v3 to v3.1.0 ([#870](https://github.com/emsearcy/heimdall/issues/870)) ([9afd7c4](https://github.com/emsearcy/heimdall/commit/9afd7c469cce8c00b32478f1b9b911e8bd5c4258))
* update module github.com/jellydator/ttlcache/v3 to v3.1.1 ([#1102](https://github.com/emsearcy/heimdall/issues/1102)) ([90dcc4d](https://github.com/emsearcy/heimdall/commit/90dcc4db63d872f86e4c0ac4b3ce9dc7ceeee7d4))
* update module github.com/jellydator/ttlcache/v3 to v3.2.0 ([#1198](https://github.com/emsearcy/heimdall/issues/1198)) ([7c560d2](https://github.com/emsearcy/heimdall/commit/7c560d21835527537afcb8704cd882220a14d61d))
* update module github.com/jellydator/ttlcache/v3 to v3.3.0 ([#1793](https://github.com/emsearcy/heimdall/issues/1793)) ([54e6cad](https://github.com/emsearcy/heimdall/commit/54e6cad5e4e8b909f646e2f0318f94388f793039))
* update module github.com/knadh/koanf/v2 to v2.1.0 ([#1178](https://github.com/emsearcy/heimdall/issues/1178)) ([1e344d3](https://github.com/emsearcy/heimdall/commit/1e344d383954cdd2daecce5ea190983f4fcb8d89))
* update module github.com/masterminds/sprig/v3 to v3.3.0 ([#1793](https://github.com/emsearcy/heimdall/issues/1793)) ([54e6cad](https://github.com/emsearcy/heimdall/commit/54e6cad5e4e8b909f646e2f0318f94388f793039))
* update module github.com/ory/ladon to v1.3.0 ([#1222](https://github.com/emsearcy/heimdall/issues/1222)) ([3ca9ec4](https://github.com/emsearcy/heimdall/commit/3ca9ec4b594d620428fa8fd2af7c31a8152d55c4))
* update module github.com/prometheus/client_golang to v1.18.0 ([#1112](https://github.com/emsearcy/heimdall/issues/1112)) ([57da7ec](https://github.com/emsearcy/heimdall/commit/57da7ecd5b47ece03faadc5215546c02434aadbe))
* update module github.com/prometheus/client_golang to v1.19.0 ([#1212](https://github.com/emsearcy/heimdall/issues/1212)) ([256932f](https://github.com/emsearcy/heimdall/commit/256932fea84666bb1814661f18cf0448bbd52190))
* update module github.com/prometheus/client_golang to v1.20.3 ([#1793](https://github.com/emsearcy/heimdall/issues/1793)) ([54e6cad](https://github.com/emsearcy/heimdall/commit/54e6cad5e4e8b909f646e2f0318f94388f793039))
* update module github.com/redis/rueidis to v1.0.45  ([#1793](https://github.com/emsearcy/heimdall/issues/1793)) ([54e6cad](https://github.com/emsearcy/heimdall/commit/54e6cad5e4e8b909f646e2f0318f94388f793039))
* update module github.com/redis/rueidis/rueidisotel to v1.0.45  ([#1793](https://github.com/emsearcy/heimdall/issues/1793)) ([54e6cad](https://github.com/emsearcy/heimdall/commit/54e6cad5e4e8b909f646e2f0318f94388f793039))
* update module github.com/rs/cors to v1.11.1 ([#1793](https://github.com/emsearcy/heimdall/issues/1793)) ([54e6cad](https://github.com/emsearcy/heimdall/commit/54e6cad5e4e8b909f646e2f0318f94388f793039))
* update module github.com/rs/zerolog to v1.30.0 ([#816](https://github.com/emsearcy/heimdall/issues/816)) ([9994289](https://github.com/emsearcy/heimdall/commit/99942896c5158ac9ab2682b628698a80085a88fd))
* update module github.com/rs/zerolog to v1.31.0 ([#936](https://github.com/emsearcy/heimdall/issues/936)) ([39f9b30](https://github.com/emsearcy/heimdall/commit/39f9b30d81bb5401185cad755094907eda2f9baa))
* update module github.com/rs/zerolog to v1.32.0 ([#1165](https://github.com/emsearcy/heimdall/issues/1165)) ([d4678f6](https://github.com/emsearcy/heimdall/commit/d4678f60e95d82e2066f1195fd66dadac469b597))
* update module github.com/spf13/cobra to v1.8.0 ([#997](https://github.com/emsearcy/heimdall/issues/997)) ([fb0bbe5](https://github.com/emsearcy/heimdall/commit/fb0bbe55035f8c2cbc30846d5386d4935066bbd6))
* update module github.com/tidwall/gjson to v1.17.0 ([#934](https://github.com/emsearcy/heimdall/issues/934)) ([8866dba](https://github.com/emsearcy/heimdall/commit/8866dbab4cb29729fe50ff805cc2ba26dc3d8350))
* update module github.com/tidwall/gjson to v1.17.1 ([#1187](https://github.com/emsearcy/heimdall/issues/1187)) ([a1680a1](https://github.com/emsearcy/heimdall/commit/a1680a13db5d3edd9d3c24ab86951a1960e70922))
* update module github.com/tonglil/opentelemetry-go-datadog-propagator to v0.1.1 ([#890](https://github.com/emsearcy/heimdall/issues/890)) ([92196e1](https://github.com/emsearcy/heimdall/commit/92196e1b140566fd8f644860dc7cf85922761912))
* update module github.com/tonglil/opentelemetry-go-datadog-propagator to v0.1.2 ([#1215](https://github.com/emsearcy/heimdall/issues/1215)) ([0d2a6ce](https://github.com/emsearcy/heimdall/commit/0d2a6cefef99b7b49ecf6f14c6677e574b07e69f))
* update module github.com/wi2l/jsondiff to v0.5.0 ([#1024](https://github.com/emsearcy/heimdall/issues/1024)) ([db99a7c](https://github.com/emsearcy/heimdall/commit/db99a7c9781335ae275fa93089aa2df1ad3ab82f))
* update module go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc to v0.46.1 ([#1045](https://github.com/emsearcy/heimdall/issues/1045)) ([1615f40](https://github.com/emsearcy/heimdall/commit/1615f4002b17577c59916b54b5f691c788f08802))
* update module go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc to v0.49.0 ([#1209](https://github.com/emsearcy/heimdall/issues/1209)) ([c51eda9](https://github.com/emsearcy/heimdall/commit/c51eda927d4587560cd1cf17f1547488c01d15dd))
* update module go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc to v0.55.0 ([#1793](https://github.com/emsearcy/heimdall/issues/1793)) ([54e6cad](https://github.com/emsearcy/heimdall/commit/54e6cad5e4e8b909f646e2f0318f94388f793039))
* update module go.opentelemetry.io/contrib/instrumentation/host to v0.46.1 ([#1045](https://github.com/emsearcy/heimdall/issues/1045)) ([1615f40](https://github.com/emsearcy/heimdall/commit/1615f4002b17577c59916b54b5f691c788f08802))
* update module go.opentelemetry.io/contrib/instrumentation/host to v0.49.0 ([#1209](https://github.com/emsearcy/heimdall/issues/1209)) ([c51eda9](https://github.com/emsearcy/heimdall/commit/c51eda927d4587560cd1cf17f1547488c01d15dd))
* update module go.opentelemetry.io/contrib/instrumentation/host to v0.55.0  ([#1793](https://github.com/emsearcy/heimdall/issues/1793)) ([54e6cad](https://github.com/emsearcy/heimdall/commit/54e6cad5e4e8b909f646e2f0318f94388f793039))
* update module go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp to v0.46.1 ([#1045](https://github.com/emsearcy/heimdall/issues/1045)) ([1615f40](https://github.com/emsearcy/heimdall/commit/1615f4002b17577c59916b54b5f691c788f08802))
* update module go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp to v0.49.0 ([#1209](https://github.com/emsearcy/heimdall/issues/1209)) ([c51eda9](https://github.com/emsearcy/heimdall/commit/c51eda927d4587560cd1cf17f1547488c01d15dd))
* update module go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp to v0.55.0  ([#1793](https://github.com/emsearcy/heimdall/issues/1793)) ([54e6cad](https://github.com/emsearcy/heimdall/commit/54e6cad5e4e8b909f646e2f0318f94388f793039))
* update module go.opentelemetry.io/contrib/instrumentation/runtime to v0.46.1 ([#1045](https://github.com/emsearcy/heimdall/issues/1045)) ([1615f40](https://github.com/emsearcy/heimdall/commit/1615f4002b17577c59916b54b5f691c788f08802))
* update module go.opentelemetry.io/contrib/instrumentation/runtime to v0.49.0 ([#1209](https://github.com/emsearcy/heimdall/issues/1209)) ([c51eda9](https://github.com/emsearcy/heimdall/commit/c51eda927d4587560cd1cf17f1547488c01d15dd))
* update module go.opentelemetry.io/contrib/instrumentation/runtime to v0.55.0  ([#1793](https://github.com/emsearcy/heimdall/issues/1793)) ([54e6cad](https://github.com/emsearcy/heimdall/commit/54e6cad5e4e8b909f646e2f0318f94388f793039))
* update module go.opentelemetry.io/contrib/propagators/autoprop to v0.46.1 ([#1045](https://github.com/emsearcy/heimdall/issues/1045)) ([1615f40](https://github.com/emsearcy/heimdall/commit/1615f4002b17577c59916b54b5f691c788f08802))
* update module go.opentelemetry.io/contrib/propagators/autoprop to v0.49.0 ([#1209](https://github.com/emsearcy/heimdall/issues/1209)) ([c51eda9](https://github.com/emsearcy/heimdall/commit/c51eda927d4587560cd1cf17f1547488c01d15dd))
* update module go.opentelemetry.io/contrib/propagators/autoprop to v0.55.0 ([#1793](https://github.com/emsearcy/heimdall/issues/1793)) ([54e6cad](https://github.com/emsearcy/heimdall/commit/54e6cad5e4e8b909f646e2f0318f94388f793039))
* update module go.opentelemetry.io/otel to v1.24.0 ([#1209](https://github.com/emsearcy/heimdall/issues/1209)) ([c51eda9](https://github.com/emsearcy/heimdall/commit/c51eda927d4587560cd1cf17f1547488c01d15dd))
* update module go.opentelemetry.io/otel/bridge/opentracing to v1.24.0 ([#1209](https://github.com/emsearcy/heimdall/issues/1209)) ([c51eda9](https://github.com/emsearcy/heimdall/commit/c51eda927d4587560cd1cf17f1547488c01d15dd))
* update module go.opentelemetry.io/otel/exporters/otlp/otlpmetric/otlpmetricgrpc to v1.24.0 ([#1209](https://github.com/emsearcy/heimdall/issues/1209)) ([c51eda9](https://github.com/emsearcy/heimdall/commit/c51eda927d4587560cd1cf17f1547488c01d15dd))
* update module go.opentelemetry.io/otel/exporters/otlp/otlpmetric/otlpmetrichttp to v1.24.0 ([#1209](https://github.com/emsearcy/heimdall/issues/1209)) ([c51eda9](https://github.com/emsearcy/heimdall/commit/c51eda927d4587560cd1cf17f1547488c01d15dd))
* update module go.opentelemetry.io/otel/exporters/otlp/otlptrace to v1.24.0 ([#1209](https://github.com/emsearcy/heimdall/issues/1209)) ([c51eda9](https://github.com/emsearcy/heimdall/commit/c51eda927d4587560cd1cf17f1547488c01d15dd))
* update module go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc to v1.24.0 ([#1209](https://github.com/emsearcy/heimdall/issues/1209)) ([c51eda9](https://github.com/emsearcy/heimdall/commit/c51eda927d4587560cd1cf17f1547488c01d15dd))
* update module go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracehttp to v1.24.0 ([#1209](https://github.com/emsearcy/heimdall/issues/1209)) ([c51eda9](https://github.com/emsearcy/heimdall/commit/c51eda927d4587560cd1cf17f1547488c01d15dd))
* update module go.opentelemetry.io/otel/exporters/prometheus to v0.46.0 ([#1209](https://github.com/emsearcy/heimdall/issues/1209)) ([c51eda9](https://github.com/emsearcy/heimdall/commit/c51eda927d4587560cd1cf17f1547488c01d15dd))
* update module go.opentelemetry.io/otel/exporters/zipkin to v1.24.0 ([#1209](https://github.com/emsearcy/heimdall/issues/1209)) ([c51eda9](https://github.com/emsearcy/heimdall/commit/c51eda927d4587560cd1cf17f1547488c01d15dd))
* update module go.opentelemetry.io/otel/metric to v1.24.0 ([#1209](https://github.com/emsearcy/heimdall/issues/1209)) ([c51eda9](https://github.com/emsearcy/heimdall/commit/c51eda927d4587560cd1cf17f1547488c01d15dd))
* update module go.opentelemetry.io/otel/sdk to v1.24.0 ([#1209](https://github.com/emsearcy/heimdall/issues/1209)) ([c51eda9](https://github.com/emsearcy/heimdall/commit/c51eda927d4587560cd1cf17f1547488c01d15dd))
* update module go.opentelemetry.io/otel/sdk/metric to v1.24.0 ([#1209](https://github.com/emsearcy/heimdall/issues/1209)) ([c51eda9](https://github.com/emsearcy/heimdall/commit/c51eda927d4587560cd1cf17f1547488c01d15dd))
* update module go.opentelemetry.io/otel/trace to v1.24.0 ([#1209](https://github.com/emsearcy/heimdall/issues/1209)) ([c51eda9](https://github.com/emsearcy/heimdall/commit/c51eda927d4587560cd1cf17f1547488c01d15dd))
* update module go.uber.org/fx to v1.20.1 ([#978](https://github.com/emsearcy/heimdall/issues/978)) ([98f67a0](https://github.com/emsearcy/heimdall/commit/98f67a0d64e56ea18a859778b48517fd0dbc6c8f))
* update module go.uber.org/fx to v1.21.0 ([#1244](https://github.com/emsearcy/heimdall/issues/1244)) ([99963e0](https://github.com/emsearcy/heimdall/commit/99963e0232a4246fb37a61dd2500fdc7efac08ac))
* update module gocloud.dev to v0.33.0 ([#821](https://github.com/emsearcy/heimdall/issues/821)) ([c002b1e](https://github.com/emsearcy/heimdall/commit/c002b1e2e1a52bea0cb79ebda91e66e954103961))
* update module gocloud.dev to v0.34.0 ([#879](https://github.com/emsearcy/heimdall/issues/879)) ([25ae833](https://github.com/emsearcy/heimdall/commit/25ae833f439737fcf7ba61d8b0a4e6e3ba95fbca))
* update module gocloud.dev to v0.36.0 ([#1113](https://github.com/emsearcy/heimdall/issues/1113)) ([584d51f](https://github.com/emsearcy/heimdall/commit/584d51f8f0afdfc3e64fc85a4e107e73c2f6ddf1))
* update module gocloud.dev to v0.37.0 ([#1236](https://github.com/emsearcy/heimdall/issues/1236)) ([8d1c7fe](https://github.com/emsearcy/heimdall/commit/8d1c7feaeefac6109b8c7c01188dfea268a251a7))
* update module gocloud.dev to v0.39.0 ([#1774](https://github.com/emsearcy/heimdall/issues/1774)) ([4ffa9e4](https://github.com/emsearcy/heimdall/commit/4ffa9e45227c177ba5f729b6111d6551de5a67a8))
* update module google.golang.org/genproto/googleapis/rpc to b0ce06b ([#1209](https://github.com/emsearcy/heimdall/issues/1209)) ([c51eda9](https://github.com/emsearcy/heimdall/commit/c51eda927d4587560cd1cf17f1547488c01d15dd))
* update module google.golang.org/grpc to v1.59.0 ([#977](https://github.com/emsearcy/heimdall/issues/977)) ([9211fae](https://github.com/emsearcy/heimdall/commit/9211faeee037434b013182f753e9d52e38479086))
* update module google.golang.org/grpc to v1.60.1 ([#1105](https://github.com/emsearcy/heimdall/issues/1105)) ([329f647](https://github.com/emsearcy/heimdall/commit/329f647a7047e8a2027296f1686d2760ef3cde24))
* update module google.golang.org/grpc to v1.62.1 ([#1220](https://github.com/emsearcy/heimdall/issues/1220)) ([d22d0d2](https://github.com/emsearcy/heimdall/commit/d22d0d2626a8c67c8e3b728fd82e1aa298746b9c))
* update module google.golang.org/grpc to v1.66.2 ([#1793](https://github.com/emsearcy/heimdall/issues/1793)) ([54e6cad](https://github.com/emsearcy/heimdall/commit/54e6cad5e4e8b909f646e2f0318f94388f793039))
* update module google.golang.org/protobuf to v1.32.0 ([#1109](https://github.com/emsearcy/heimdall/issues/1109)) ([47d7785](https://github.com/emsearcy/heimdall/commit/47d77852d7840c82f29eb2db460bb6f930b5ddfd))
* update module google.golang.org/protobuf to v1.33.0 ([#1221](https://github.com/emsearcy/heimdall/issues/1221)) ([e2dab94](https://github.com/emsearcy/heimdall/commit/e2dab9456fd4f1f5a265a6106858610da33fb995))
* update module k8s.io/client-go to v0.31.1  ([#1793](https://github.com/emsearcy/heimdall/issues/1793)) ([54e6cad](https://github.com/emsearcy/heimdall/commit/54e6cad5e4e8b909f646e2f0318f94388f793039))
* update module k8s.io/klog/v2 to v2.110.1 ([#994](https://github.com/emsearcy/heimdall/issues/994)) ([e1b655a](https://github.com/emsearcy/heimdall/commit/e1b655af3fa425b1892a5c127c64859f5b34d032))
* update module k8s.io/klog/v2 to v2.120.1 ([#1139](https://github.com/emsearcy/heimdall/issues/1139)) ([541828b](https://github.com/emsearcy/heimdall/commit/541828bbcfd0d838a1349a27951514a2c439bab4))
* update opentelemetry-go monorepo to v1.21.0 ([#1045](https://github.com/emsearcy/heimdall/issues/1045)) ([1615f40](https://github.com/emsearcy/heimdall/commit/1615f4002b17577c59916b54b5f691c788f08802))
* update opentelemetry-go monorepo to v1.30.0  ([#1793](https://github.com/emsearcy/heimdall/issues/1793)) ([54e6cad](https://github.com/emsearcy/heimdall/commit/54e6cad5e4e8b909f646e2f0318f94388f793039))
